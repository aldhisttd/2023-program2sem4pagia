...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES['photo']['name'] !== '') {
        ...
        $query = "UPDATE kendaraan SET tanggal_masuk='$tanggal_masuk', jenis_kendaraan='$jenis_kendaraan', harga=$harga, photo='$photo' WHERE kode='$kode'";
    } else {
        // Query untuk update data tanpa foto baru
        $query = "UPDATE kendaraan SET tanggal_masuk='$tanggal_masuk', jenis_kendaraan='$jenis_kendaraan', harga=$harga WHERE kode='$kode'";
    }
