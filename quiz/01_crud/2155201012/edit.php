...
if(isset($_POST['btn-update'])){
    ...
    mysqli_query($koneksi, "UPDATE genap SET nama_karyawan='$nama_karyawan', tgl_lahir='$tgl_lahir'
...
<body>
    ...
    $data = mysqli_query($koneksi, "SELECT * FROM genap WHERE id_karyawan='$id_karyawan'");
