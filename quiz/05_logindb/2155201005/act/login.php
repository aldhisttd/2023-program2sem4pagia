...
if (isset($_POST['btnlogin'])) {
    ...
    $login = mysqli_query($koneksi,"SELECT * FROM akun WHERE userForm='$userForm' and passForm='$passForm'");
    ...
    if($cek > 0){
        ...
        }elseif($data['userForm']=="karyawan"){
            // buat session login dan username
            $_SESSION['sudah_login'] = $userForm;
            $_SESSION['userForm'] = "karyawan";
